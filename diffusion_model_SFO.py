...
nsteps=100
beta=1. - np.exp(np.log(0.02)/float(nsteps))
nhid_mu=32
nhid_cov=8
nout_mu=32
nout_cov=8
...
muW0=(np.random.randn(nx, nhid_mu)*0.1).astype(np.float32)
muW1=(np.random.randn(nhid_mu, nout_mu)*0.1).astype(np.float32)
muW2=(np.random.randn(nout_mu, ntgates*nx)*0.1).astype(np.float32)
mub0=np.zeros(nhid_mu).astype(np.float32)
mub1=np.zeros(nout_mu).astype(np.float32)
mub2=np.zeros(nx).astype(np.float32)

covW0=(np.random.randn(nx, nhid_cov)*0.1).astype(np.float32)
covW1=(np.random.randn(nhid_cov, nout_cov)*0.1).astype(np.float32)
covW2=(np.random.randn(nout_cov, ntgates*nx)*0.1).astype(np.float32)
