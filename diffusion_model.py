...
class diffusion_model():
	...
	def __init__(self, nx, nb, nsteps, beta, nhid_mu, nhid_cov, ntgates=10):
		...
		covW1=np.random.randn(nhid_cov, ntgates)*0.1
	...
	def compute_f_mu(self, x, t):
		...
		#z=z+T.reshape(x/T.sqrt(1.0-self.beta),(t.shape[0],t.shape[1],1,self.nx))
		...
		tgating=T.exp(-200.0*(tpoints-t)**2)
	...
	def compute_f_cov(self, x, t):
		...
		z=T.reshape(z,(t.shape[0],t.shape[1],self.ntgates,1))+self.covb1 #nt by nb by ntgates by 1
		z=T.exp(z)
